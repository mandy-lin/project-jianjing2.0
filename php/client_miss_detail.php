...
$data=mysqli_query($con,"select * from client  where c_no='$id'"); 
...
<div class="card mb-4">
    ...
    <p>合約到期日：<input type="date" style="border-style:none" readonly="readonly" value="<?php echo $rs["end_date"];?>"></p>
...
<p>總幹事：<input class="editable1" type="text" style="border-style:none" readonly="readonly" name="ganshi_name" value="<?php echo $rs2["ganshi_name"];?>">電話：<input class="editable1" type="text" style="border-style:none" readonly="readonly" value="<?php echo $rs2["ganshi_phone"];?>"><br>其他聯絡方式：<textarea class="editable1" style="border-style:none" readonly="readonly" name="ganshi_conn"><?php echo $rs2["ganshi_conn"];?></textarea></p>
